...
- After the `promo-writer` skill generates initial copy
...
Options:
1. Generate promo copy: the `promo-writer` skill <album-name>
...
Next steps:
  ...
  3. Ready for release: the `release-director` skill <album>
```
