...
### Skill
A slash command that invokes specialized functionality. Skills are invoked with the `skill-name` skill Each skill has its own SKILL.md documentation in `../../skills/[skill-name]/`.
...
| `../..` | (location of plugin) | `~/.claudeplugin managements/bitwize-music` |
